         ...
         <div className='container'>
            ...
            <div className='row flex justify-center items-center pt-6'>
               <div className='col-md-11 text-lg bg-blue-100 py-4 history_box'>
                  ...
                  <p className='pl-5 py-2'>Example of UseState :</p>
                  <div className='pics md:flex gap-2 py-2'>
                     <p className='flex justify-center items-center py-3'><img src={PD_example_1} alt='Not Found..'></img></p>
                     <p className='flex justify-center items-center py-3'><img src={PD_example_2} alt='Not Found..'></img></p>
                     <p className='flex justify-center items-center py-3'><img src={PD_example_3} alt='Not Found..'></img></p>
                  </div>
