    ...
    <h1 className='intro_heading text-center text-5xl font-bold'>UseContext Hook</h1>
        <div className='row flex justify-center items-center pt-6'>
            <div className='col-md-11 text-lg bg-slate-100 py-4'>
                <p><span className='text-green-600'> --> </span>It is a built-in hook that allows functional components to have state variables.</p>
                <p><span className='text-green-600'> --> </span>It is a function that takes an initial state as an argument and returns an array with two elements: </p>                   
