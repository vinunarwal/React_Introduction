        ...
        <div className='row flex justify-center items-center pt-6'>
          <div className='col-md-11 text-lg bg-blue-100 py-4 history_box'>
            ...
            <div className='pics md:flex gap-2 py-2'>
              <p className='flex justify-center items-center py-3'><img src={Usecontext_eg_1} alt='Not Found..'></img></p>
              <p className='flex justify-center items-center py-3'><img src={Usecontext_eg_2} alt='Not Found..'></img></p>
              <p className='flex justify-center items-center py-3'><img src={Usecontext_eg_3} alt='Not Found..'></img></p>
            </div>
